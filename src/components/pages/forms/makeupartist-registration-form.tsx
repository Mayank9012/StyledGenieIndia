    ...
    <div className="min-h-screen bg-gradient-to-b from--50 to--100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="bg-gray-600 py-6 px-8">
          <h1 className="text-2xl font-bold text-white">Freelance Makeup Artist Registration</h1>
          <p className="text-rose-100 mt-2">Join our network of professional makeup artists</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="col-span-1">
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-rose-500 focus:outline-none focus:ring-rose-500"
                placeholder="e.g., $50/hour or $350/day"
              />
            </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="agreeToTerms" className={`font-medium ${errors.agreeToTerms ? 'text-indigo-700' : 'text-gray-700'}`}>
                    I agree to the <a href="#" className="text-indigo-600 hover:text-rose-500">Terms and Conditions</a> and <a href="#" className="text-indigo-600 hover:text-rose-500">Privacy Policy</a> <span className="text-red-500">*</span>
                  </label>
                  {errors.agreeToTerms && (
